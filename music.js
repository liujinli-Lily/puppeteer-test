...
(async () => {
    ...
    await MyMethods.mkdirFn(path.dirname(__filename) + '/lyric','lyric');
    let writerStream = fs.createWriteStream(path.dirname(__filename) + '/lyric/'+new Date().getTime() +'_lyric.txt');
